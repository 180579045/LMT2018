...
namespace SuperLMT.Utils
{
    ...
    public class ConvertUtil
    {
        ...
        /// The log.
        /// </summary>
        private static readonly ILog Log = LogManager.GetLogger(typeof(ConvertUtil));

        /// <summary>
        /// The instance.
        /// </summary>
        private static readonly ConvertUtil Instance = new ConvertUtil();
        ...
        /// Gets the singleton.
        /// </summary>
        public static ConvertUtil Singleton
        {
            get
            {
                return Instance;
        ...
        private void Initialize()
        {
            ...
            this.dataConverters.Add("UINT64",this.ConvertByteArrayToUint64);
        ...
        /// <summary>
        /// The convert byte array to unsigned integer64 value.
        /// </summary>
        /// <param name="rawDataBuf"></param>
        /// <returns></returns>
        private object ConvertByteArrayToUint64(byte[] rawDataBuf)
        {
            if (rawDataBuf == null)
            {
                return null;
            ...
            var dataBufferToReverse = new byte[8];
            Array.Copy(rawDataBuf, dataBufferToReverse, Math.Min(rawDataBuf.Length, dataBufferToReverse.Length));
            ...
            {
                Array.Reverse(dataBufferToReverse);
                UInt64 int64Data = BitConverter.ToUInt64(dataBufferToReverse,0);
                return int64Data;
            }
            catch (Exception ex)
            {
                Log.Error("ConvertByteArrayToUint64 error,message = " + ex.Message);
                return null;
            }
        }
