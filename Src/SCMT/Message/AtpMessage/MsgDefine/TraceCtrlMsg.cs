...
namespace AtpMessage.MsgDefine
{
	...
	internal struct MsgGtsm2GtsaDspTraceCtrlReq : IASerialize
	{
	...
	/*跟踪控制消息*/
	[Serializable, StructLayout(LayoutKind.Sequential, Pack = 1, CharSet = CharSet.Ansi)]
	internal struct MsgGtsm2GtsaTraceCtrlReq : IASerialize
	{
	...
	/*跟踪控制响应*/
	[Serializable, StructLayout(LayoutKind.Sequential, Pack = 1, CharSet = CharSet.Ansi)]
	internal struct MsgGtsa2GtsmTraceCtrlRsp : IASerialize
	{
		public GtsMsgHeader header;                         /*GTS消息头*/
