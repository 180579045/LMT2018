...
namespace SCMTOperationCore.Connection
{
	...
	public abstract class Connection : IDisposable
	{
		...
		/// </summary>
		/// <param name="reason">link break reason for client use</param>
		...
		/// </remarks>
		protected void InvokeDisconnected(BreakLinkReason reason, Exception e = null)
		{
			DisconnectedEventArgs args = DisconnectedEventArgs.GetObject();
			args.Set(e);
			args.BreakReason = reason;
		...
		protected void InvokeConnected(Exception e = null)
		{
			ConnectedEventArgs args = ConnectedEventArgs.GetObject();
			args.Set(e);
