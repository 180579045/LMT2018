...
namespace SCMTOperationCore.Connection
{
    ...
    public class ConnectionStatistics
    {
        ...
        /// </remarks>
        public void LogUnreliableSend(int dataLength, int totalLength)
        {
        ...
        ///     This should be called after the data has been sent and should only be called for data that is sent sucessfully.
        /// </remarks>
        public void LogReliableSend(int dataLength, int totalLength)
        {
        ...
        ///     This should be called after the data has been sent and should only be called for data that is sent sucessfully.
        /// </remarks>
        public void LogFragmentedSend(int dataLength, int totalLength)
        {
        ...
        ///     This should be called after the data has been sent and should only be called for data that is sent sucessfully.
        /// </remarks>
        public void LogAcknowledgementSend(int totalLength)
        {
        ...
        ///     This should be called after the data has been sent and should only be called for data that is sent sucessfully.
        /// </remarks>
        public void LogHelloSend(int totalLength)
        {
