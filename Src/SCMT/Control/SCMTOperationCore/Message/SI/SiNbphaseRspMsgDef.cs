	...
	**************************************************************************************************/
	public class SI_NBPHASE_REP_MSG : IASerialize
	{
		...
		public int DeserializeToStruct(byte[] bytes, int offset)
		{
			...
			used += SerializeHelper.SerializeBytes(ref u48NodeBEquID.m_value, 0, bytes, offset + used, 6);
		...
		public ushort ContentLen => (ushort)(u48NodeBEquID.Len + sizeof(ushort) + sizeof(byte) * 42 + struNodeBSystemTime.Len);
	}
