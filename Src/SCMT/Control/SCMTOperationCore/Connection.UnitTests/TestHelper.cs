...
namespace SCMTOperationCore.Connection.UnitTests
{
    [TestClass]
    public static class TestHelper
    {
        ...
        internal static void RunServerToClientTest(ConnectionListener listener, SCMTOperationCore.Connection.Connection connection, int dataSize, SendOption sendOption)
        {
            //Setup meta stuff 
