...
{
    [TestClass()]
    public class NPECheckRulesDealTests
    {
        public NPECheckRulesDealTests()
        {
            Log.SetLogFileName("NPECheckRulesDealTests.log");
        }
        ...
        public static MAP_DEVTYPE_DEVATTRI SimGetNetPlanEnbMib()
        {
            ...
            oneBoard.m_mapAttributes["netBoardRowStatus"].m_strLatestValue = 4.ToString();
            oneBoard.m_mapAttributes["netBoardType"].m_strLatestValue = 178.ToString();
            oneBoard.m_mapAttributes["netBoardWorkMode"].m_strLatestValue = 2.ToString();
            oneBoard.m_mapAttributes["netBoardIrFrameType"].m_strLatestValue = 1.ToString();
            oneBoard.m_mapAttributes["netBoardRowStatus"].m_strOriginValue = 4.ToString();
            oneBoard.m_mapAttributes["netBoardType"].m_strOriginValue = 240.ToString();
            oneBoard.m_mapAttributes["netBoardWorkMode"].m_strOriginValue = 2.ToString();
            oneBoard.m_mapAttributes["netBoardIrFrameType"].m_strOriginValue = 2.ToString();
            netBoardInfo.Add(oneBoard);
        ...
        public async Task CheckAllPlanDataTest1()
        {
            await simConnectEnb();
            MAP_DEVTYPE_DEVATTRI mapMib_this = SimGetNetPlanEnbMib();
            NPECheckRulesDeal rulesHelper = new NPECheckRulesDeal(mapMib_this, 10);
            string falseTip;
            bool res = rulesHelper.CheckAllPlanData(out falseTip);
            Assert.IsTrue(res == false);
        }
